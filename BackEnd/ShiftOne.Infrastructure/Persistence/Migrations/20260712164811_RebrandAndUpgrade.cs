...
{
    /// <inheritdoc />
    public partial class RebrandAndUpgrade : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    BoundOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ResetOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ResetBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    UpdatedOn = table.Column<DateTime>(type: "datetime2", nullable: true)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EmployeeDevices_Users_EmployeeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxHRUsers = table.Column<int>(type: "int", nullable: true),
                    MaxCompanyAdmins = table.Column<int>(type: "int", nullable: true),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    UpdatedOn = table.Column<DateTime>(type: "datetime2", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AllowedRadius = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttendanceRecords_CompanyId_EmployeeId_AttendanceDate",
                table: "AttendanceRecords",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Branches_CompanyId_IsMainBranch",
                table: "Branches",
                columns: new[] { "CompanyId", "IsMainBranch" },
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompanySubscriptions_CompanyId_IsActive",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeDevices_EmployeeId_IsActive",
                table: "EmployeeDevices",
